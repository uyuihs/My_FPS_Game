...
public class ResetAnimatorBool : StateMachineBehaviour
{
    ...
    public string isPerformingActions = "isPerformingActions";
    public bool isPerformingActionsStatus = false;
    ...
    {
        animator.SetBool(isPerformingActions, isPerformingActionsStatus);
